...
export const IRS_EXPENSE_CATEGORIES: Record<string, IrsCategory> = {
  ...
  car_truck: {
    ...
    keywords: ["gas", "fuel", "gasoline", "diesel", "car wash", "parking", "toll", "auto repair", "car repair", "vehicle maintenance", "oil change", "tire", "uber", "lyft", "taxi", "car rental", "hertz", "enterprise", "avis", "shell", "chevron", "exxon", "bp", "jiffy lube", "pep boys", "firestone", "goodyear", "ez pass", "fastrak"]
  },
  commissions_fees: {
    name: "Commissions and Fees",
    description: "Fees paid to contractors or services",
    keywords: ["commission", "referral fee", "broker fee", "stripe fee", "paypal fee", "square fee", "merchant fee", "processing fee", "transaction fee"]
  },
  contract_labor: {
    name: "Contract Labor",
    description: "Payments to independent contractors",
    keywords: ["contractor", "freelancer", "consultant", "fiverr", "upwork", "toptal", "99designs", "contract work", "subcontractor", "1099"]
  },
  depletion: {
    name: "Depletion",
  ...
  employee_benefits: {
    ...
    keywords: ["health insurance", "dental insurance", "vision insurance", "401k", "retirement", "pension", "hsa", "fsa", "life insurance", "disability insurance", "benefits"]
  },
  insurance: {
    name: "Insurance (other than health)",
    description: "Business insurance premiums",
    keywords: ["liability insurance", "business insurance", "professional insurance", "e&o insurance", "malpractice", "property insurance", "workers comp", "commercial insurance"]
  },
  interest_mortgage: {
    name: "Interest (Mortgage)",
    description: "Mortgage interest paid to banks",
    keywords: ["mortgage interest", "home loan interest", "property interest"]
  },
  interest_other: {
    name: "Interest (Other)",
    description: "Other business interest expenses",
    keywords: ["loan interest", "credit card interest", "line of credit interest", "business loan", "finance charge", "interest charge"]
  },
  legal_professional: {
    name: "Legal and Professional Services",
    description: "Attorney, accountant, consultant fees",
    keywords: ["attorney", "lawyer", "legal", "law firm", "accountant", "cpa", "bookkeeper", "tax prep", "quickbooks", "turbotax", "h&r block", "consultant", "professional services", "notary"]
  },
  office_expense: {
    name: "Office Expense",
    description: "Office supplies and small equipment",
    keywords: ["office depot", "staples", "office supplies", "paper", "ink", "toner", "printer", "desk", "chair", "office furniture"]
  },
  ...
  rent_lease_equipment: {
    ...
    keywords: ["equipment rental", "equipment lease", "copier lease", "printer lease"]
  },
  rent_lease_property: {
    name: "Rent or Lease (Property)",
    description: "Office or business property rent",
    keywords: ["office rent", "rent", "lease payment", "commercial rent", "warehouse rent", "storage unit", "coworking", "wework"]
  },
  repairs_maintenance: {
    name: "Repairs and Maintenance",
    description: "Repairs to business property/equipment",
    keywords: ["repair", "maintenance", "fix", "service call", "technician", "handyman", "plumber", "electrician", "hvac", "cleaning service"]
  },
  supplies: {
    name: "Supplies",
    description: "Materials and supplies used in business",
    keywords: ["supplies", "materials", "inventory", "raw materials", "amazon business", "wholesale", "bulk purchase"]
  },
  taxes_licenses: {
    name: "Taxes and Licenses",
    description: "Business taxes and license fees",
    keywords: ["business license", "permit", "registration", "state tax", "local tax", "property tax", "sales tax", "franchise tax"]
  },
  travel: {
    name: "Travel",
    description: "Business travel expenses",
    keywords: ["airline", "flight", "airfare", "united", "delta", "american airlines", "southwest", "jetblue", "hotel", "marriott", "hilton", "hyatt", "airbnb", "lodging", "travel", "expedia", "booking.com"]
  },
  meals: {
  ...
  utilities: {
    ...
    keywords: ["electric", "electricity", "power", "gas bill", "water bill", "phone", "internet", "wifi", "broadband", "comcast", "verizon", "at&t", "t-mobile", "spectrum", "utility"]
  },
  wages: {
    name: "Wages",
    description: "Employee wages and salaries",
    keywords: ["payroll", "salary", "wages", "gusto", "adp", "paychex", "employee pay"]
  },
  home_office: {
  ...
  education_training: {
    ...
    keywords: ["training", "course", "seminar", "conference", "workshop", "webinar", "udemy", "coursera", "linkedin learning", "certification"]
  },
  software_subscriptions: {
    name: "Software and Subscriptions",
    description: "Software licenses and SaaS subscriptions",
    keywords: ["software", "subscription", "saas", "microsoft", "adobe", "zoom", "slack", "dropbox", "google workspace", "office 365", "salesforce", "github", "aws", "notion", "figma"]
  },
  bank_charges: {
    name: "Bank Charges",
    description: "Bank fees and service charges",
    keywords: ["bank fee", "service charge", "monthly fee", "overdraft", "wire fee", "atm fee"]
  },
  shipping: {
    name: "Shipping and Postage",
    description: "Shipping and mailing costs",
    keywords: ["shipping", "postage", "usps", "ups", "fedex", "dhl", "mail", "freight", "courier"]
  },
  suspected_personal: {
    name: "Suspected Personal",
    description: "Expenses that may be personal and not business-related",
    keywords: ["gamestop", "steam games", "playstation", "xbox", "nintendo", "movie ticket", "cinema", "concert", "bar", "nightclub", "casino", "jewelry", "spa", "salon", "gym", "fitness", "yoga", "golf"]
  },
  other: {
    name: "Other Expenses",
